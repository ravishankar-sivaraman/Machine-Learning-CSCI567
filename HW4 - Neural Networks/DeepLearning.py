...
# xTrain = xTrainNorm[0:500]
# yTrain = yTrain[0:500]
# xTest = xTestNorm[0:100]
# yTest = yTest[0:100]
...
#X_tr, y_tr, X_te, y_te, archs, actfn='relu', last_act='softmax', reg_coeffs=[0.0], num_epoch=30, batch_size=1000, sgd_lr=1e-5, sgd_decays=[0.0], sgd_moms=[0.0], sgd_Nesterov=False, EStop=False, verbose=0
...
#print "Best selected values"
#print "Regularizarion = " + str(bestRegularization) + " Decay = " + str(bestDecay[2]) + " Momentum = " + str(bestMomentum[3])
startTime = default_timer()
